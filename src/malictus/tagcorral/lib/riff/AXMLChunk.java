...
/**
 * Represents an AXML chunk.
 */
public class AXMLChunk extends PlainTextChunk {
	
	private RIFFChunk parentChunk;
	
	/**
	 * AXMLChunk creator method.
	 * 
	 ...
	 */
	public AXMLChunk(TCFile parentFile, long startByte, long length, TCRaf raf, RIFFChunk parentChunk) throws IOException {
